...
class LoginModel extends Model{	
	...
	/*protected $_validate=array(
		...
		array('user',		'callback_checklen',	'用户名过长',	0,	'callback'),
		array('pwd',		'require',		'密码必须非空'			),
		array('num',		'require',		'学号必须非空'			),
		array('clas',		'require',		'班级必须非空'			),
		array('sex',		'require',		'性别必须非空'			),
		array('mails',		'require',		'邮箱必须非空'			),
		//array('repassword',	'require',		'请重复输入密码'		),
		//array('pass',		'repassword','两次输入的密码不一致，请重新输入',		0,	'confirm'),
