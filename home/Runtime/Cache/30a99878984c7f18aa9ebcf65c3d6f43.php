...
<body>	
<div id="main_head">
	<p>欢迎光临<?php echo ($login_name); ?>,进入个人空间管理<span id="room"><a href="__URL__/">返回</a></span><span id="msg"><img src="__PUBLIC__/Images/home/comments.png" />短消息</span></p>
</div>
<!-- wrap starts here -->
<div id="wrap">
    ...
    <div id="ro_content">
    	<div id="ro_left">
        	<div id="p_img">
            	<img src="__PUBLIC__/Images/home/name.jpg" width="150" height="160" />
            </div>
            <div id="list">
            ...
            <div id="list">
            	...
            	<ul>
                	<li><a href="__URL__/work_list/" target="ifr">查看作业</a></li>
                    <li><a href="#">提交作业</a></li>
                </ul>
            </div>
        </div>
        <div id="ro_right">
        	<iframe id="ifr" name="ifr" src="__URL__/basic_info" frameborder="0"></iframe>
        </div>
