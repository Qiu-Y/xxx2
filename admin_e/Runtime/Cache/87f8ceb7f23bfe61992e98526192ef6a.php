...
<div id="body-wrapper">
	    ...
	    <ul id="main-nav">
            ...
            <li> <a href="#" class="nav-top-item current">用户管理</a>
	          <ul>
                ...
                <li><a class="current" href="#">后台用户</a></li>
	          </ul>
	        </li>
  ...
  <div id="main-content">
 <div id="tt">
 	<a href="__URL__/add_teacher"><input type="button" value="添加" onclick="location.href('__URL__/add_teacher')" style="width:40px; height:30px;"></a>
 </div>
    <noscript>
          ...
          <table>
            ...
            <tbody>
			  <?php if(is_array($teacher_list)): $i = 0; $__LIST__ = $teacher_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                      <a href="__URL__/add_class/clas/<?php echo ($vo['id']); ?>" title="编辑"><img src="__PUBLIC__/Images/admin/icons/pencil.png" alt="修改" /></a> 
