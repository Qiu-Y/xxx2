  ...
  <div id="main-content">
	...
	<br></br>
   	...
   	<form action="__URL__/<?php echo ($btn_ok_act); ?>"  method="post">
		...
		<div>
			<input type="text" id="txtTitle" name="subject" style="width:460px; height:20px; float:left;" maxlength="100" value="<?php echo ($article_item["title"]); ?>"/>
            <?php
 if($temp==0) { ?>
                ...
                <?php
                    ...
                    <select name="second" id="second">
                        <option value="<?php echo ($mm['f_cata']); ?>"><?php echo ($mm['f_cata']); ?></option>
                    </select>
                <?php
 } ?>
	    ...
	    <div id="myEditor">
			<script type="text/javascript">
				var editor = new baidu.editor.ui.Editor({
				    ...
				    initialContent: '<?php echo ($article_item["content"]); ?>'
				});
