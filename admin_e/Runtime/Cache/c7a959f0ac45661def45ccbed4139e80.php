...
<div id="body-wrapper">
	    ...
	    <ul id="main-nav">
            ...
            <li> <a href="#" class="nav-top-item current">用户管理</a>
	          <ul>
	            ...
	            <li><a class="current" href="#">学生管理</a></li>
 ...
 <img src="__PUBLIC__/Images/admin/ico.png" width="20" height="20" /><font style="font-size:14px; color:#333; font-weight:bold;">班级查找：</font>
     <select name="select" id="selType">
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">人数(共<?php echo ($news_count); ?>篇)</a></li>
          ...
          <table>
            ...
            <tbody>
			  <?php if(is_array($student_list)): $i = 0; $__LIST__ = $student_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><a href="#" class="clas" title="<?php echo ($vo['clas']); ?>"><?php echo ($vo['clas']); ?></a></td>
                    <td><a href="#" class="name" title="<?php echo ($vo['name']); ?>,<?php echo ($vo['phone']); ?>,<?php echo ($vo['num']); ?>"><?php echo ($vo['name']); ?></a> </td>
                    <td><?php echo ($vo['num']); ?></td>
                    <td><?php echo ($vo['phone']); ?> </td>
                    <td>
                      <a href="__URL__/delete_ss/id/<?php echo ($vo['id']); ?>" title="删除"><img src="__PUBLIC__/Images/admin/icons/cross.png" alt="删除" /></a>
                    </td>
