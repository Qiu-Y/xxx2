...
<div id="body-wrapper">
    ...
    <div id="sidebar-wrapper">
	    ...
	    <ul id="main-nav">
             ...
             <li> <a href="#" class="nav-top-item current">视频</a>
	          <ul>
	            <li><a class="current" href="__URL__/film_mag">视频管理</a></li>
  ...
  <div id="main-content">
    ...
    <div id="find">
        <form action="__URL__/film_mag" method="get">
      ...
      <div></div>
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <!-- 表内容部分 -->
            <tbody>
              <?php if(is_array($film_list)): $i = 0; $__LIST__ = $film_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td></td>
