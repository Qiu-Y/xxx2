  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
	    ...
	    <ul id="main-nav">
            ...
            <li> <a href="#" class="nav-top-item current">视频</a>
	          <ul>
	            <li><a href="__URL__/film_mag">视频管理</a></li>
	            <li><a class="current" href="#">视频添加</a></li>
	          </ul>
	        </li>
  ...
  <div id="main-content">
	...
	<br></br>
   	...
   	<form action="__URL__/<?php echo ($btn_ok_act); ?>"  method="post">
		...
		<div>
			<input type="text" id="txtTitle" name="subject" style="width:460px; height:20px; float:left;" maxlength="100" value="<?php echo ($film_item["title"]); ?>"/>
            <?php
 if($temp==0) { ?>
	    ...
	    <div id="myEditor">
			<script type="text/javascript">
				var editor = new baidu.editor.ui.Editor({
				    ...
				    initialContent: '<?php echo ($film_item["content"]); ?>'
				});
				editor.render("myEditor");
			</script>
		</div>
		<br></br>
		<input type="hidden" value="<?php echo ($film_item["id"]); ?>" name="id"/>
