...
<div id="body-wrapper">
	    ...
	    <ul id="main-nav">
	        ...
	        <li> <a href="#" class="nav-top-item current">目录管理</a>
	          <ul>
	            ...
	            <li><a class="current" href="#">添加二级目录</a></li>
	          </ul>
	        </li>
  ...
  <div id="main-content">
 <div id="tt">
 <img src="__PUBLIC__/Images/admin/ico.png" width="20" height="20" /><font style="font-size:14px; font-weight:bold;">添加二级目录</font>
 </div>
    <noscript>
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
       <form action="__URL__/add_s" method="post">
       	父级目录：<select name="sel">
        			<?php if(is_array($news_list)): $i = 0; $__LIST__ = $news_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mm): $mod = ($i % 2 );++$i;?><option value="<?php echo ($mm['f_cata']); ?>"><?php echo ($mm['f_cata']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
       			  </select>
                  <br />
                  <br />
       	
        子级目录：<input type="text" name="second" />	
        
        <?php
 if($mm['isf']==0){ ?>
            	<input type="checkbox" name="checkbox" value="isf">视频<br />
        ...
        <input type="submit" name="add" value="添加" style="width:50px; height:30px;"/>
       </form>
